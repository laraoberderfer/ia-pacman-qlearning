...
class PacmanQAgent(QLearningAgent):
    ...
    #def __init__(self, epsilon=0.05,gamma=0.8,alpha=0.2, numTraining=0, **args): #padrao
    def __init__(self, epsilon=0.1,gamma=0.7,alpha=0.3, numTraining=0, **args):
    #def __init__(self, epsilon=50,gamma=0.7,alpha=80, numTraining=0, **args):
        """
        These default parameters can be changed from the pacman.py command line.
        For example, to change the exploration rate, try:
            python pacman.py -p PacmanQLearningAgent -a epsilon=0.1
        epsilon  - exploration rate | gamma    - discount factor|
         alpha    - learning rate          
